...
set -e
export hdfs_server="emr-master.twdutttau.training:8020"
export kafka_server="kafka.twdutttau.training:9092"
...
nohup java -jar /tmp/tw-citibike-apis-producer0.1.0.jar --spring.profiles.active=${station_information} --kafka.brokers=kafka.twdutttau.training:9092 1>/tmp/${station_information}.log 2>/tmp/${station_information}.error.log &
nohup java -jar /tmp/tw-citibike-apis-producer0.1.0.jar --spring.profiles.active=${station_san_francisco} --producer.topic=station_data_sf --kafka.brokers=kafka.twdutttau.training:9092 1>/tmp/${station_san_francisco}.log 2>/tmp/${station_san_francisco}.error.log &
nohup java -jar /tmp/tw-citibike-apis-producer0.1.0.jar --spring.profiles.active=${station_france} --producer.topic=station_data_fr --kafka.brokers=kafka.twdutttau.training:9092 1>/tmp/${station_france}.log 2>/tmp/${station_france}.error.log &
nohup java -jar /tmp/tw-citibike-apis-producer0.1.0.jar --spring.profiles.active=${station_status} --kafka.brokers=kafka.twdutttau.training:9092 1>/tmp/${station_status}.log 2>/tmp/${station_status}.error.log &
